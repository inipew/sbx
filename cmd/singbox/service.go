...
// 	Use:   "service",
// 	Short: "Kelola layanan Sing-box (start, stop, restart)",
// }

// func init() {
// 	ServiceCmd.AddCommand(&cobra.Command{
// 		Use:   "start",
// 		Short: "Mulai layanan Sing-box",
// 		Run: func(cmd *cobra.Command, args []string) {
// 			if err := service.StartService(); err != nil {
// 				fmt.Println("Gagal memulai layanan Sing-box:", err)
// 				return
// 			}
// 			fmt.Println("Layanan Sing-box berhasil dimulai.")
// 		},
// 	})

// 	ServiceCmd.AddCommand(&cobra.Command{
// 		Use:   "stop",
// 		Short: "Hentikan layanan Sing-box",
// 		Run: func(cmd *cobra.Command, args []string) {
// 			if err := service.StopService(); err != nil {
// 				fmt.Println("Gagal menghentikan layanan Sing-box:", err)
// 				return
// 			}
// 			fmt.Println("Layanan Sing-box berhasil dihentikan.")
// 		},
// 	})
...
// 				fmt.Println("Gagal merestart layanan Sing-box:", err)
// 				return
// 			}
// 			fmt.Println("Layanan Sing-box berhasil direstart.")
// 		},
// 	})

// 	ServiceCmd.AddCommand(&cobra.Command{
// 		Use:   "logs",
// 		Short: "Ambil log layanan Sing-box",
// 		Run: func(cmd *cobra.Command, args []string) {
...
var ServiceCmd = &cobra.Command{
    ...
    Long:  "Perintah untuk enable, disable, start, stop, restart layanan sing-box dan membuat systemd service.",
}
...
func runSystemdCommand(action string) {
    cmd := exec.Command("systemctl", action, "sing-box")
    err := cmd.Run()
    if err != nil {
        shared.Error(fmt.Sprintf("Error executing systemctl %s: %v", action, err))
        return
    }
    shared.Info(fmt.Sprintf("Successfully executed systemctl %s for sing-box service.", action))
}
